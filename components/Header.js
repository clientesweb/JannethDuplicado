      ...
      <nav class="container mx-auto px-4" role="navigation" aria-label="Navegación principal">
          <div class="flex items-center justify-between h-20">
              ...
              <div class="md:hidden flex items-center space-x-1">
                  <!-- Mobile Social Icons (reduced set) -->
                  <a href="https://www.instagram.com/janneth_aguirrem/" 
                     target="_blank" 
                     rel="noopener noreferrer" 
                     class="p-2 text-gray-600 hover:text-primary hover:bg-primary/5 rounded-full transition-all duration-300"
                  ...
                  <!-- Mobile Menu Toggle -->
                  <button class="p-2 text-gray-600 hover:text-primary hover:bg-primary/5 rounded-lg transition-colors duration-300" aria-label="Abrir menú">
