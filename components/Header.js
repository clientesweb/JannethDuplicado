  ...
  <header class="sticky top-0 z-40 bg-white/80 backdrop-blur-md shadow-sm">
      <div class="container mx-auto px-4">
          <div class="flex items-center justify-between h-20">
              ...
              <!-- Mobile Menu Button -->
              <button id="mobileMenuButton" class="md:hidden text-gray-600 hover:text-primary transition-colors duration-300">
          ...
          <div class="h-full w-full flex flex-col">
              ...
              <div class="flex-1 overflow-y-auto bg-white">
                  <nav class="py-8 px-6 space-y-6">
                      <a href="#inicio" class="flex items-center space-x-4 text-lg text-gray-700 hover:text-primary transition-colors duration-300">
                          <i class="fas fa-home w-6"></i>
                          <span>Inicio</span>
                      </a>
                      <a href="#servicios" class="flex items-center space-x-4 text-lg text-gray-700 hover:text-primary transition-colors duration-300">
                          <i class="fas fa-concierge-bell w-6"></i>
                          <span>Servicios</span>
                      </a>
                      <a href="property-listing.html" class="flex items-center space-x-4 text-lg text-gray-700 hover:text-primary transition-colors duration-300">
                          <i class="fas fa-building w-6"></i>
                          <span>Propiedades</span>
                      </a>
                      <a href="#sobre-nosotros" class="flex items-center space-x-4 text-lg text-gray-700 hover:text-primary transition-colors duration-300">
                          <i class="fas fa-users w-6"></i>
                          <span>Nosotros</span>
                      </a>
                      <a href="#avances-obra" class="flex items-center space-x-4 text-lg text-gray-700 hover:text-primary transition-colors duration-300">
                          <i class="fas fa-hard-hat w-6"></i>
                          <span>Avances de Obra</span>
                      </a>
                      <a href="#revista-online" class="flex items-center space-x-4 text-lg text-gray-700 hover:text-primary transition-colors duration-300">
                          <i class="fas fa-newspaper w-6"></i>
                          <span>Revista Online</span>
                      </a>
                      <a href="#playlists" class="flex items-center space-x-4 text-lg text-gray-700 hover:text-primary transition-colors duration-300">
                          <i class="fas fa-play w-6"></i>
                          <span>Videos</span>
                      </a>
                      <a href="#contacto" class="flex items-center space-x-4 text-lg text-gray-700 hover:text-primary transition-colors duration-300">
                          <i class="fas fa-envelope w-6"></i>
                          <span>Contacto</span>
                      </a>
                      <a href="#descargar" class="flex items-center space-x-4 text-lg text-gray-700 hover:text-primary transition-colors duration-300">
