        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#servicios" class="hover:text-accent transition-colors duration-300 text-sm md:text-base">Servicios</a></li>
                        <li><a href="#sobre-nosotros" class="hover:text-accent transition-colors duration-300 text-sm md:text-base">Sobre Nosotros</a></li>
                        <li><a href="#contacto" class="hover:text-accent transition-colors duration-300 text-sm md:text-base">Contacto</a></li>
                        <li><a href="#descargar" class="hover:text-accent transition-colors duration-300 text-sm md:text-base">Descargar App</a></li>
                    </ul>
                </div>
                <div>
            ...
            <div class="mt-8 pt-8 border-t border-white/20 text-center pb-20 md:pb-0">
                <p class="text-sm md:text-base">&copy; 2023 Janneth Aguirre Bienes Raíces. Todos los derechos reservados.</p>
